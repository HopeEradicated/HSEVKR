...
sys.path.append("./src/aot")
from src.aot.networks.engines.aot_engine import AOTEngine, AOTInferEngine
from src.aot.networks.engines.deaot_engine import DeAOTEngine, DeAOTInferEngine
import importlib
import numpy as np
...
import src.aot.dataloaders.video_transforms as tr
from src.aot.utils.checkpoint import load_network
from src.aot.networks.models import build_vos_model
from src.aot.networks.engines import build_engine
